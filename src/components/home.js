                        ...
                        moviedata.map((data, index) => {
                            ...
                            return <div className="col-4" key={index} style={{ marginLeft: "auto", marginRight: "auto" }}>
                                <div className="card">
                                    ...
                                    <button onClick={() => history.push({ pathname: "/details", state: { videourl: data.data.videourl, moviename: data.data.moviename, description: data.data.description, actorname: data.data.actorname, directorname: data.data.directorname, releasedate: data.data.releasedate, outdate: data.data.outdate } })}>View Details</button>
